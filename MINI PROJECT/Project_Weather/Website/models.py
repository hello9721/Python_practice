...
class Location(models.Model):
    one = models.TextField(db_column='ONE', blank=True, null=True)  # Field name made lowercase.
    two = models.TextField(db_column='TWO', blank=True, null=True)  # Field name made lowercase.
    thr = models.TextField(db_column='THR', blank=True, null=True)  # Field name made lowercase.
